...
public class IngredientControllerTest {
	...
	public void setUp() throws Exception {
		...
		piece = new UnitOfMeasureCommand(1L, "Piece");
	...
	public void testAddIngredient() throws Exception {
		IngredientCommand dc = new IngredientCommand(1L, recipe.getId(), "Salt", new BigDecimal(0.5f), piece);
	...
	public void testUpdateIngredient() throws Exception {
		...
		IngredientCommand dcUpdated = new IngredientCommand(1L, recipe.getId(), "Sugar", new BigDecimal(0.5f), piece);
